...
class PanelURL(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.labelNewConnection.grid(row=0, column=0, columnspan=2, sticky=tk.E + tk.W)

        self.labelDescription = tk.Label(self, text="Connect to a MongoDB deployment")
        self.labelDescription.grid(row=1, column=0, columnspan=2, sticky=tk.E + tk.W)
        ...
        self.labelAdvanceConnectionOptions.grid(row=4, column=0, columnspan=2, sticky=tk.E + tk.W)
