...
class PanelOptions(tk.Frame):
    def __init__(self, parent):
        ...
        self.labelUserManager.grid(row=0, sticky=tk.W)
        ...
        self.buttonUpdateUser.grid(row=2, sticky=tk.W + tk.E)
        ...
        self.labelRolManager.grid(row=4, sticky=tk.W)
        ...
        self.buttonUpdateRol.grid(row=6, sticky=tk.W + tk.E)
